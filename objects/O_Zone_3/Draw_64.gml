...
if(isVisible == true){	/// @DnDAction : YoYo Games.Drawing.Set_Color
	...
	/// @DnDArgument : "caption" ""Trade Three : Special item 3""
	/// @DnDArgument : "text" ""need 15 [item 1] // 10[item 2]  // 10 [item 3]""
	draw_text_transformed(x, y, string("Trade Three : Special item 3") + string("need 15 [item 1] // 10[item 2]  // 10 [item 3]"), 2, 2, 0);}
	...
	var l5AE43584_0;l5AE43584_0 = keyboard_check_pressed(ord("E"));if (l5AE43584_0){	/// @DnDAction : YoYo Games.Common.If_Variable
		...
		if(O_ManagerItem.loot1 >= 15){	/// @DnDAction : YoYo Games.Common.If_Variable
			...
			if(O_ManagerItem.loot2 >= 10){	/// @DnDAction : YoYo Games.Common.If_Variable
				...
				/// @DnDHash : 5A89B288
				/// @DnDParent : 5555C0C5
				/// @DnDArgument : "var" "O_ManagerItem.loot3"
				/// @DnDArgument : "op" "4"
				/// @DnDArgument : "value" "10"
				if(O_ManagerItem.loot3 >= 10){	/// @DnDAction : YoYo Games.Common.Variable
					/// @DnDVersion : 1
					/// @DnDHash : 5A20C20E
					/// @DnDInput : 4
					/// @DnDParent : 5A89B288
					...
					/// @DnDArgument : "var" "O_ManagerItem.loot1"
					/// @DnDArgument : "var_1" "O_ManagerItem.SPLOOT3"
					/// @DnDArgument : "var_2" "O_ManagerItem.loot2"
					/// @DnDArgument : "var_3" "O_ManagerItem.loot3"
					O_ManagerItem.loot1 += -15;
					O_ManagerItem.SPLOOT3 += 1;
					O_ManagerItem.loot2 += -10;
					O_ManagerItem.loot3 += -10;}}}}}